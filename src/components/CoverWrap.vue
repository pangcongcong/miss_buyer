...
.st0{fill:#ECD714;}
.st1{fill:#E9B115;}
.st2{fill:#FE0808; animation: st2 2.5s ease-out infinite; -webkit-animation: st2 2.5s ease-out infinite;}
.st3{fill:#E60000;}
.st4{fill:#FE1200;}
.st5{fill:#4E4707;}
.st6{fill:#180403;}
...
.header-nav-left:hover.logo::after {
	content: 'ピカ ピカ';
	position: absolute;
	margin-left: 100%;
	font-size: 8px;
	...
	font-weight: bold;
	opacity: 0;
	animation: showpika 1s ease-in;
	animation-delay: 0.2s;
	animation-fill-mode: forwards;
}
.header-nav-left:hover .logo {
	animation: pikachu 1s ease-in;
	animation-fill-mode: forwards;
}
.header-con {
	position: relative;
